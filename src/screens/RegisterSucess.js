    ...
    return (
      ...
      style={[styles.container]}>
        ...
        style={styles.innerContainer}>
          ...
          <Text text='Success!' textStyle={styles.title}
          style={[globalStyles.Heading1]} />
          </View>

          <View style={{position: 'absolute', alignItems: 'center', width: '70%', alignSelf: 'center', padding: '15%'}}>
          <Text textStyle={styles.subTitle} textAlign = 'center' text='You have successfully' />   
          <Text textStyle={styles.subTitle} textAlign = 'center' text='registered your Hospital' />   
          </View>
  ...
  const Footer = () => {
    return (
      <View style={styles.footerContainer}>
        ...
        <Button containerStyle={styles.containerStyle} onPress={() => navigation.replace('Home')} textStyle={styles.textStyle} title='Continue'/>
      </View>
    )
  }
